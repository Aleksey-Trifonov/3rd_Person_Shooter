#undef THIRD_PERSON_SHOOTER_API
...
#define UE_PROJECT_NAME Third_Person_Shooter
#define UE_TARGET_NAME Third_Person_ShooterEditor
...
#define THIRD_PERSON_SHOOTER_API DLLEXPORT
